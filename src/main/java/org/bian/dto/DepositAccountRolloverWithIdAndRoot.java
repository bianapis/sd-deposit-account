...
/**
 * DepositAccountRolloverWithIdAndRoot
 */
public class DepositAccountRolloverWithIdAndRoot   {
  private String depositAccountRolloverHandlingTaskReference = null;
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: reference to the processing of a term deposit rollover request 
   * @return depositAccountRolloverHandlingTaskReference
  **/

  public String getDepositAccountRolloverHandlingTaskReference() {
    return depositAccountRolloverHandlingTaskReference;
  }

  public void setDepositAccountRolloverHandlingTaskReference(String depositAccountRolloverHandlingTaskReference) {
    this.depositAccountRolloverHandlingTaskReference = depositAccountRolloverHandlingTaskReference;
  }
